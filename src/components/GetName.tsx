...
function GetName({ getName }: GetNameProps) {
  ...
  return (
    <>
      <div className='fixed w-[460px] h-screen bg-slate-950 opacity-80 z-50'></div>
      <div className="fixed w-[460px] h-full grid place-content-center z-50">
        <div className='w-80 h-48 rounded-lg bg-slate-50 flex flex-col justify-center items-center gap-5'>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col gap-3 items-center'>
            <input type="text" name="name" className='border-2 border-slate-950 focus:rounded-lg rounded-lg px-1 h-9 text-center' autoComplete='off' />
